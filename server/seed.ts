...
async function seed() {
  ...
  type ApptInsert = {
    ...
    checkInTime?: Date; consultationStartTime?: Date; completedAt?: Date;
  };

  const appts: ApptInsert[] = [
    // 6 days ago
    { patientId: p1!.id, doctorId: doc1!.user.id, date: daysAgo(6, 9, 15), status: "completed", reason: "Routine checkup", notes: "BP 130/85", queueNumber: 1, queuePosition: 1, checkInTime: daysAgo(6, 9, 10), consultationStartTime: daysAgo(6, 9, 20), completedAt: daysAgo(6, 9, 32), clinicId },
    { patientId: p3!.id, doctorId: doc1!.user.id, date: daysAgo(6, 10, 0), status: "completed", reason: "Fever & cold", queueNumber: 2, queuePosition: 2, checkInTime: daysAgo(6, 9, 55), consultationStartTime: daysAgo(6, 10, 35), completedAt: daysAgo(6, 10, 47), clinicId },
    { patientId: p7!.id, doctorId: doc2!.user.id, date: daysAgo(6, 9, 30), status: "completed", reason: "Child vaccination", queueNumber: 1, queuePosition: 1, checkInTime: daysAgo(6, 9, 25), consultationStartTime: daysAgo(6, 9, 35), completedAt: daysAgo(6, 9, 50), clinicId },
    // 5 days ago
    { patientId: p2!.id, doctorId: doc3!.user.id, date: daysAgo(5, 11, 0), status: "completed", reason: "Gynaecology consult", queueNumber: 1, queuePosition: 1, checkInTime: daysAgo(5, 10, 50), consultationStartTime: daysAgo(5, 11, 10), completedAt: daysAgo(5, 11, 35), clinicId },
    { patientId: p5!.id, doctorId: doc1!.user.id, date: daysAgo(5, 9, 0), status: "no_show", reason: "Follow-up", queueNumber: 1, queuePosition: 1, clinicId },
    { patientId: p8!.id, doctorId: doc1!.user.id, date: daysAgo(5, 10, 0), status: "completed", reason: "Diabetes review", queueNumber: 2, queuePosition: 2, checkInTime: daysAgo(5, 9, 55), consultationStartTime: daysAgo(5, 10, 15), completedAt: daysAgo(5, 10, 30), clinicId },
    // 4 days ago
    { patientId: p4!.id, doctorId: doc3!.user.id, date: daysAgo(4, 10, 30), status: "completed", reason: "Prenatal checkup", queueNumber: 1, queuePosition: 1, checkInTime: daysAgo(4, 10, 20), consultationStartTime: daysAgo(4, 10, 40), completedAt: daysAgo(4, 11, 5), clinicId },
    { patientId: p6!.id, doctorId: doc2!.user.id, date: daysAgo(4, 9, 0), status: "completed", reason: "Child fever", queueNumber: 1, queuePosition: 1, checkInTime: daysAgo(4, 8, 55), consultationStartTime: daysAgo(4, 9, 10), completedAt: daysAgo(4, 9, 25), clinicId },
    { patientId: p10!.id, doctorId: doc1!.user.id, date: daysAgo(4, 11, 0), status: "cancelled", reason: "General OPD", queueNumber: 3, queuePosition: 3, clinicId },
    // 3 days ago
    { patientId: p9!.id, doctorId: doc1!.user.id, date: daysAgo(3, 9, 0), status: "completed", reason: "Chest pain", notes: "ECG normal", queueNumber: 1, queuePosition: 1, checkInTime: daysAgo(3, 8, 50), consultationStartTime: daysAgo(3, 9, 5), completedAt: daysAgo(3, 9, 20), clinicId },
    { patientId: p11!.id, doctorId: doc2!.user.id, date: daysAgo(3, 10, 0), status: "completed", reason: "Child growth checkup", queueNumber: 1, queuePosition: 1, checkInTime: daysAgo(3, 9, 58), consultationStartTime: daysAgo(3, 10, 15), completedAt: daysAgo(3, 10, 33), clinicId },
    // 2 days ago
    { patientId: p12!.id, doctorId: doc3!.user.id, date: daysAgo(2, 11, 0), status: "completed", reason: "PCOS consult", queueNumber: 1, queuePosition: 1, checkInTime: daysAgo(2, 10, 55), consultationStartTime: daysAgo(2, 11, 10), completedAt: daysAgo(2, 11, 35), clinicId },
    { patientId: p1!.id, doctorId: doc1!.user.id, date: daysAgo(2, 10, 0), status: "completed", reason: "BP follow-up", queueNumber: 2, queuePosition: 2, checkInTime: daysAgo(2, 9, 55), consultationStartTime: daysAgo(2, 10, 12), completedAt: daysAgo(2, 10, 25), clinicId },
    // Yesterday
    { patientId: p3!.id, doctorId: doc1!.user.id, date: daysAgo(1, 9, 30), status: "completed", reason: "General OPD", queueNumber: 1, queuePosition: 1, checkInTime: daysAgo(1, 9, 25), consultationStartTime: daysAgo(1, 9, 38), completedAt: daysAgo(1, 9, 52), clinicId },
    { patientId: p2!.id, doctorId: doc3!.user.id, date: daysAgo(1, 11, 0), status: "completed", reason: "Follow-up", queueNumber: 2, queuePosition: 2, checkInTime: daysAgo(1, 10, 55), consultationStartTime: daysAgo(1, 11, 20), completedAt: daysAgo(1, 11, 45), clinicId },
    { patientId: p5!.id, doctorId: doc2!.user.id, date: daysAgo(1, 10, 0), status: "no_show", reason: "Vaccination", queueNumber: 1, queuePosition: 1, clinicId },
    // Today – live queue
    { patientId: p4!.id,  doctorId: doc1!.user.id, date: new Date(today.getTime() + 9*3600000),   status: "completed",   reason: "Routine checkup", queueNumber: 1, queuePosition: 1, checkInTime: new Date(today.getTime() + 8.9*3600000), consultationStartTime: new Date(today.getTime() + 9.1*3600000), completedAt: new Date(today.getTime() + 9.3*3600000), clinicId },
    { patientId: p6!.id,  doctorId: doc1!.user.id, date: new Date(today.getTime() + 9.5*3600000), status: "in_progress", reason: "Chest cold", queueNumber: 2, queuePosition: 2, checkInTime: new Date(today.getTime() + 9.4*3600000), consultationStartTime: new Date(today.getTime() + 9.6*3600000), clinicId },
    { patientId: p8!.id,  doctorId: doc1!.user.id, date: new Date(today.getTime() + 10*3600000),  status: "checked_in",  reason: "Diabetes review", queueNumber: 3, queuePosition: 3, checkInTime: new Date(today.getTime() + 9.8*3600000), clinicId },
    { patientId: p10!.id, doctorId: doc1!.user.id, date: new Date(today.getTime() + 10.5*3600000),status: "checked_in",  reason: "Hypertension", queueNumber: 4, queuePosition: 4, checkInTime: new Date(today.getTime() + 10.2*3600000), clinicId },
    { patientId: p12!.id, doctorId: doc2!.user.id, date: new Date(today.getTime() + 9*3600000),   status: "completed",   reason: "Child fever", queueNumber: 1, queuePosition: 1, checkInTime: new Date(today.getTime() + 8.9*3600000), consultationStartTime: new Date(today.getTime() + 9.1*3600000), completedAt: new Date(today.getTime() + 9.25*3600000), clinicId },
    { patientId: p7!.id,  doctorId: doc2!.user.id, date: new Date(today.getTime() + 9.5*3600000), status: "in_progress", reason: "Vaccination", queueNumber: 2, queuePosition: 2, checkInTime: new Date(today.getTime() + 9.45*3600000), consultationStartTime: new Date(today.getTime() + 9.55*3600000), clinicId },
    { patientId: p9!.id,  doctorId: doc2!.user.id, date: new Date(today.getTime() + 10*3600000),  status: "booked",      reason: "Follow-up", queueNumber: 3, queuePosition: 3, clinicId },
    { patientId: p11!.id, doctorId: doc3!.user.id, date: new Date(today.getTime() + 10*3600000),  status: "checked_in",  reason: "Gynaecology OPD", queueNumber: 1, queuePosition: 1, checkInTime: new Date(today.getTime() + 9.85*3600000), clinicId },
    { patientId: p2!.id,  doctorId: doc3!.user.id, date: new Date(today.getTime() + 10.5*3600000),status: "booked",      reason: "PCOS follow-up", queueNumber: 2, queuePosition: 2, clinicId },
  ];
